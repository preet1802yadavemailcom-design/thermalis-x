...
dataset_builder = """import numpy as np
import pandas as pd
...
with open("ml/training/dataset_builder.py", "w", encoding="utf-8") as f:
    f.write(dataset_builder)

train_models = """import os
import json
import numpy as np
import pandas as pd
...
with open("ml/training/train_xgboost.py", "w", encoding="utf-8") as f:
    f.write(train_models)

print("ML Training pipeline files created.")
